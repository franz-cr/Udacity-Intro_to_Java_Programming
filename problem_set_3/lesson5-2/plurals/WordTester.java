...
public class WordTester
{
    public static void main(String[] args)
    {
        ...
        System.out.println(new Word("tomato").getPluralForm());
        System.out.println("Expected: tomatoes");
        ...
        System.out.println(new Word("city").getPluralForm());
        System.out.println("Expected: cities");
        System.out.println(new Word("puppy").getPluralForm());
        System.out.println("Expected: puppies");
    }
}
