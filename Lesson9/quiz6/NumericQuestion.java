...
// TODO: Specify superclass
{
    ...
    */
    ...
    public boolean checkAnswer(String response)
    {
        ...
        double dblResponse, lowerLimit, upperLimit;
        
        dblResponse = Double.parseDouble(response);
        lowerLimit = this.answer - this.tolerance;
        upperLimit = this.answer + this.tolerance;
        
        if (dblResponse > lowerLimit && dblResponse < upperLimit)
            return true;
        else
            return false;
    }
