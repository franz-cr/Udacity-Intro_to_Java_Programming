...
public class WindowShape
{
    ...
    // semi-circle on top. WindowShape.area(100, 300.0)
    public static double area(double rectWidth, double rectHeight) {
        //this.w = rectWidth;
        //this.h = rectHeight;
        double radius = rectWidth / 2;
        double circle = radius * radius * Math.PI;
        return rectWidth * rectHeight + circle / 2;
    }    
}
